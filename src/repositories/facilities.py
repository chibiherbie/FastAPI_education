...
from src.shemas.facilities import Facility, RoomFacility
...
class RoomsFacilitiesRepository(BaseRepository):
    ...
    async def set_room_facilities(self, room_id: int, facilities_id: list[int]) -> None:
        ...
        ids_to_delete: list[int] = list(set(current_facilities_ids) - set(facilities_id))
        ids_to_insert: list[int] = list(set(facilities_id) - set(current_facilities_ids))
